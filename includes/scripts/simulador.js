var objParcelas = {
  ...
  $("#btn-calcular").click(function() {
    ...
    if (camposValidos()) {
      ...
      var valorLote = parseFloat(moneyToFloat($("#valor-lote").val()));
      var valorEntrada = parseFloat(valorLote) * 0.3; // 30% DO VALOR DO LOTE;
      /* var tac = 10; */ // CASO VENHAMOS A TRABALHAR COM A TAC
  
      var taxaJuros = parseFloat(objParcelas[qtdParcelas].juros);
      var valorFinanciado = valorLote - valorEntrada + tac;
